...
file_path = 'bs_6.log'  # Replace with the path to your file
file_path = 'bs_8.log'  # Replace with the path to your file
file_path = 'bs_10.log'  # Replace with the path to your file
file_path = 'bs_16.log'  # Replace with the path to your file
...
with open(file_path, 'r') as file:
    lines = file.readlines()[997:1086]  # Lines are 0-indexed, so 3917 corresponds to line 3918
...
print("forward time average  (ms) ", sum(fw_values)/len(fw_values))
...
print("backward time average (ms) ", sum(bw_values)/len(bw_values))

print()

print("optimizer time average (ms)", sum(opt_values)/len(opt_values))
...
print('the avg iteration time (ms)', avg_iteration)
print()
