...
file_path = 'bs_4.log'  # Replace with the path to your file
file_path = 'bs_8.log'  # Replace with the path to your file
# file_path = 'bs_10.log'  # Replace with the path to your file
# file_path = 'bs_14.log'  # Replace with the path to your file
...
with open(file_path, 'r') as file:
    lines = file.readlines()[3921:4228]  # Lines are 0-indexed, so 3917 corresponds to line 3918
